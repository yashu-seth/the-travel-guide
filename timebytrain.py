...
def findtimebytrain():
    ...
    url='https://maps.googleapis.com/maps/api/distancematrix/json?origins='+yo[0]+'&destinations='+yo[1]+'&key=AIzaSyB0Z5xwCsHNYnkA1YSYFePn_qNOQ-R27MM'+'&transit=train'
    ...
    for elem in j_res["rows"]:
        for each in elem["elements"]:
            ...
            print "Duration by train "+each["duration"]["text"]
